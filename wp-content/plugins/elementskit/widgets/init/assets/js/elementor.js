! function(e, t) {
    ...
    let i = {
        ...
        Unfold: function(e) {
            var t = e.find(".ekit-unfold-btn"),
                i = e.find(".ekit-unfold-wrapper"),
                n = e.find(".ekit-unfold-data"),
                a = e.find(".ekit-unfold-data-inner"),
                s = t.find(".collapse-btn"),
                o = t.find(".expand-btn"),
                l = i.data("config"),
                r = parseInt(l.transition_duration, 10) || 300,
                d = s.length > 0 || o.length > 0;
            ...
            function c(e) {
                if (d) {
                    ...
                    i && (i.nodeValue = ElementsKit_Helper.removeSpecificCharacters(e))
                } else t.html(ElementsKit_Helper.removeSpecificCharacters(e))
            }

            function p(e) {
                d && ("collapse" === e ? (s.show(), o.hide()) : (o.show(), s.hide()))
            }
            l.collapse_height >= a.outerHeight() ? (t.hide(), n.addClass("active").height("auto")) : (t.show(), n.removeClass("active").height(l.collapse_height)), t.off("click").on("click", (function() {
                var e = n.hasClass("active");
                e ? (n.stop().animate({
                    height: l.collapse_height
                }, r), c(l.expand_text), p("expand")) : (n.stop().animate({
                    height: a.outerHeight()
                }, r, (function() {
                    n.height("auto")
                })), c(l.collapse_text), p("collapse")), n.toggleClass("active"), e && requestAnimationFrame((() => {
                    n[0].scrollIntoView({
                        block: "center",
                        behavior: "smooth"
                    })
        ...
        Hotspot: function(t) {
            ...
            function s() {
                ...
                let o = function(e) {
                        ...
                        if (void 0 !== i) return t <= i.mobile ? "mobile" : t <= i.tablet ? "tablet" : "desktop"
                    }(e(this)),
                    l = e(this).data("directions");
                if (l && (e(this).removeClass((function(e, t) {
                        return (t.match(/ekit_hotspot_follow_line_\w+/g) || []).join(" ")
                    })), l ? .[o] ? e(this).addClass(`${l[o]}`) : e(this).addClass(`${l?.desktop}`)), e(this).hasClass("ekit_hotspot_follow_line_top") ? t.css({
                        bottom: a,
                        top: "auto"
            ...
            e(window).load((function() {
                ...
                e(window).width() <= 480 && a.hasClass("hotspot-following-line-style") && e(window).width() <= 480 && (a.removeClass("ekit_hotspot_follow_line_top ekit_hotspot_follow_line_bottom ekit_hotspot_follow_line_right_top ekit_hotspot_follow_line_right_bottom ekit_hotspot_follow_line_left_bottom ekit_hotspot_follow_line_right ekit_hotspot_follow_line_left ekit_hotspot_follow_line_left_top"), a.removeClass("hotspot-following-line-style").addClass("hotspot-following-line-straight ekit_hotspot_follow_line_top")), t.find(".ekit-location_outer").each((function() {
                    ...
                    a.each(s)
                }), 1e3), e(window).on("resize", (function() {
        ...
        Advanced_Search: function(t) {
                ...
                e.ajax({
                    ...
                    success: function(t) {
                        ! function(t) {
                            ...
                            l.show(), h.hide(), r.html(t), n > s.postsPerPage ? f.show() : f.hide();
                            a !== undefined ? (u.hide(), r.css({
                                display: "flex"
                            })) : r.css({
                                display: ""
                            })
                    ...
                    complete: function() {
                        c.css({
                            ...
                            display: "inline-flex"
                        }), k(), d.off("click").on("click", (function() {
                            p.val(""), g()
                        }))
                    },
                    error: function(e) {
            ...
            m(), e(window).on("mouseup", (function(t) {
                ...
                function() {
                    if ("click-expand" === s.styleSelect) {
                        ...
                        o.hide(), e.on("click", (function(e) {
                            e.preventDefault(), o.toggleClass("s-show"), o.hasClass("s-show") ? (t.hide(), i.show(), o.show()) : (t.show(), i.hide(), o.hide())
                        }))
                    }
                }(), s.styleSelect, n.on("input submit", (function(e) {
                    e.preventDefault(), v()

...
function(t, e) {
    ...
    function o(o) {
        if (i(), "string" == typeof o && (o = document.querySelector(o)), o && "object" == typeof o && o.nodeType) {
            ...
            for (var u = h.isBorderBox = "border-box" == s.boxSizing, c = 0; c < a; c++) {
                var d = r[c],
                    l = s[d],
                    f = parseFloat(l);
                h[d] = isNaN(f) ? 0 : f
            ...
            var p = h.paddingLeft + h.paddingRight,
                ...
                x = u && n,
                z = t(s.width);
            !1 !== z && (h.width = z + (x ? 0 : p + v));
            var I = t(s.height);
            return !1 !== I && (h.height = I + (x ? 0 : m + _)), h.innerWidth = h.width - (p + v), h.innerHeight = h.height - (m + _), h.outerWidth = h.width + g, h.outerHeight = h.height + y, h
        }
    }
...
function(t, e) {
    ...
    return o._resetLayout = function() {
        ...
        for (var h = (this._getOption("originTop") ? o.top : o.bottom) + i.outerHeight, u = r; u <= a; u++) this.colYs[u] = Math.max(h, this.colYs[u])
...
function(t, e) {
    ...
    var i = "string" == typeof document.documentElement.style.transform ? "transform" : "WebkitTransform",
        ...
        n = o.prototype = Object.create(t.Item.prototype),
        s = n._create;
    n._create = function() {
    ...
    return n.moveTo = function(t, e) {
        ...
        return n ? void this.goTo(t, e) : void r.apply(this, arguments)
...
function(t, e) {
    ...
    h._create = function() {
        ...
        l.forEach((function(t) {
            ...
            if (this._addShiftTarget(i, o, a), h)
    ...
    h.itemDragMove = function(t, e, i) {
        ...
        if (n) {
            ...
            var s = this,
                r = new Date;
            this._itemDragTime && r - this._itemDragTime < 120 ? (clearTimeout(this.dragTimeout), this.dragTimeout = setTimeout(o, 120)) : (o(), this._itemDragTime = r)
        }
    }, h.itemDragEnd = function(t) {
        function e() {
            2 == ++o && (i.element.classList.remove("is-positioning-post-drag"), i.hideDropPlaceholder(), n.dispatchEvent("dragItemPositioned", null, [i]))
        }
